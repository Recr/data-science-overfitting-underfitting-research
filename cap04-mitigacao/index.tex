...
Pelas técnicas de regularização, os parâmetros recebem penalidades, reduzindo a variância dos modelos e, consequentemente, resultando em um modelo mais otimizado e enxuto. \cite{electronics11040521} 
\begin{itemize}
  \item \textbf{L1 (Lasso)}: Adiciona uma penalidade proporcional 
à soma dos valores absolutos dos pesos. Sua propriedade mais notável é a capacidade de induzir esparsidade, zerando efetivamente os pesos de features consideradas irrelevantes, realizando assim uma forma de seleção de features automática. \cite{datilio2021regularizacao}
